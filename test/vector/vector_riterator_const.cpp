...
int main()
{
	...
	rit = rite;
	std::cout << "rit = rite" << (*rit) << std::endl;
	rit = v.rbegin();
	...
	const NAMESPACE::vector<int>::reverse_iterator rit2 = v.rbegin();
	const NAMESPACE::vector<int>::reverse_iterator rite2 = v.rend();
	crit = rit;
	std::cout << "crit = rit " << (*crit) << std::endl;
	crit = rite;
	std::cout << "crit = rite " << (*crit) << std::endl;
std::cout << "cite:" << *crite << std::endl;
	std::cout << "ite2:" << *rite2 << std::endl;
